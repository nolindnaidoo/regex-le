...
- **[regex-le](https://github.com/nolindnaidoo/regex-le/tree/main/crate)** — This extension's own CLI: find every regex in a codebase and report which can be driven into catastrophic backtracking
